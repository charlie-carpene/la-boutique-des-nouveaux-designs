...
puts "***** Items ... *****"
10.times do
  Item.create(name: Faker::Creature::Cat.name, category: Category.all.sample, description: Faker::TvShows::HowIMetYourMother.quote, price: Faker::Number.number(digits:2), available_qty: Faker::Number.number(digits:1), shop: Shop.all.sample)
end
puts "... done"

class UsersController < ApplicationController
  ...
  def edit
    ...
    unless load_user.is_admin? #can't use load_resource because it takes the params from the URL and here we want the current_user id
  ...
  def update
    ...
    if load_user.is_admin? && @user_to_validate.save
